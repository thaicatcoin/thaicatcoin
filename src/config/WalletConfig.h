...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "TCAT";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "TCAT";
    ...
    const std::string daemonName = "ThaiCatCoind";
    ...
    const std::string contactLink = "http://chat.thaicatcoin.lol";
